...
**Format:** 1080 × 1920, 30 fps, ~18s each. Ink-dominant palette with a green
accent, Montserrat headers, Inter body — straight from the TallyWise brand voice
guide. Every reel carries an **AI-generated** disclosure chip (brand rule: AI
teaches, real Abid testifies — these are teaching reels, so they're labelled).
